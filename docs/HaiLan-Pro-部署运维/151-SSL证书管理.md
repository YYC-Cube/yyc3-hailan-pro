---
@file: 151-SSL证书管理.md
@description: HaiLan Pro SSL证书管理，包含证书申请、证书更新、证书监控
...
本文档详细描述HaiLan Pro-HaiLan-Pro-部署运维-SSL证书管理相关内容，确保项目按照YYC³标准规范进行开发和实施。
...
HaiLan Pro 使用 cert-manager 实现 SSL 证书的自动化申请、续期和管理。

**证书类型：**

| 证书类型 | 用途 | 有效期 | 自动续期 |
|----------|------|--------|----------|
| Let's Encrypt | 公网服务 | 90天 | 是 |
| 自签名证书 | 内部测试 | 1年 | 否 |
| 商业证书 | 企业服务 | 1年 | 是 |
